...
const getProductByCat = require("../controllers/products/getProducyByCat");
const getProdctByBrand = require("../controllers/products/getProdyctByBrand");
...
router.get("/get/brand", getProdctByBrand);
